...
export type eNetwork = eEthereumNetwork | ePolygonNetwork | eXDaiNetwork | eAuroraNetwork;
...
export interface iAuroraPerNetwork<eNetwork> {
  [eAuroraNetwork.testnet]: eNetwork;
}
